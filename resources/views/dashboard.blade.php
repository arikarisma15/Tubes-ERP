...
<body>
    ...
    <div class="main-wrapper">
            ...
            <ul class="nav user-menu">
                ...
                {{-- <li class="nav-item dropdown has-arrow flag-nav">
                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);"
                        role="button">
                        <img src="assets/img/flags/indo2.png" alt="" height="20">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="assets/img/flags/indo.png" alt="" height="16"> Indonesia
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item">
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                <li><a href="{{ url('listproduk') }}">Product List</a></li>
                                <li><a href="{{ url('addproduk') }}">Add Product</a></li>
                                <li><a href="barcode.html">Print Barcode</a></li>
                            </ul>
                        </li>
                        <li class="submenu">
                            <a href="javascript:void(0);"><img src="assets/img/icons/sales1.svg"
                                    alt="img"><span> Bahan Baku</span> <span class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="{{ url('listbahan') }}">Material List</a></li>
                                <li><a href="{{ url('addbahan') }}">Add Material </a></li>
                            </ul>
                        </li>
                        {{-- <li class="submenu">
        ...
        <div class="content">
            @yield('content') <!-- Ini adalah tempat konten dari dashboard -->
        </div>
    </div>
